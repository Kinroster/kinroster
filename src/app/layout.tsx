...
export const metadata: Metadata = {
  ...
  // PWA install hints for iOS Safari. Android Chrome reads these from
  // /manifest.webmanifest (generated by src/app/manifest.ts) automatically;
  // iOS still needs the legacy meta tags below. statusBarStyle "default"
  // matches the brand-teal theme without forcing a black or transparent bar.
  appleWebApp: {
    capable: true,
